...
def main(args_dict):
    ...
    pretrain_list = ['nums_recon', 'nums_critic', 'drop_out']
    ...
    args_dict.update(
        {
            ...
            'task_save_path': os.path.join(path_config.result_path, f'Disyn_{args_dict["seed"]}', 'task_specific_train_step1', args_dict['drug'], param_str, task_param_str)
        })
    ...
    labeled_dataloader = data.get_labeled_dataloader_generator(gex_features_df=gex_features_df, seed=args_dict["seed"], drug=args_dict['drug'])
